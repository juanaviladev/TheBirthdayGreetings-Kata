...
import com.greetings.desktop.adapters.ui.StorageSettings

class PlainTextEmployeeRepository(private val storageSettings: StorageSettings) : EmployeeRepository {

    override fun findAll(): List<Employee> {
        val file = storageSettings.employeesDB
